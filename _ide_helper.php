...
namespace Illuminate\Support\Facades {
     ...
     */        class Broadcast {
         ...
         */        public static function routes($attributes = null)
        {
                    ...
                    /**
         * Register the routes for handling broadcast users authentication.
         *
         * @param array|null $attributes
         * @return void
         * @static
     ...
     */        class Gate {
         ...
         */        public static function allows($ability, $arguments = [])
        {
                    ...
                    /**
         * Determine if any of the given abilities should be denied for the current users.
         *
         * @param iterable|string $ability
         * @param array|mixed $arguments
         * @return bool
     ...
     */        class Schema {
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder
                    ...
                    /**
         * Get the users-defined types that belong to the database.
         *
         * @return array
         * @static
