<div>
    <style>
        ...
        /* === JADVAL DIZAYNI (RASMDAGIDEK) === */

        /* Asosiy Header (Och ko'k) */
        ...
        /* Natijalar ichidagi O'rtacha (Kulrang) */
        .bg-gray-soft {
            background-color: #e9ecef !important;
            /* Rasm: Kulrang */
        }

        /* Yakuniy Natijalar (Sariq) */
        .bg-yellow-soft {
        ...
        .table-card {
            ...
            border-radius: 12px;
            overflow: hidden;
            /* Table burchaklari chiqib ketmasligi uchun */
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="table-card d-none d-md-block p-3">
                    ...
                    {{-- Jadval footer qismi (Pagination) --}}
                ...
                <div class="d-md-none">
                    @foreach($students as $student)
                    <div class="mobile-card" style="border-left: 5px solid var(--yuksalish-orange); background: white; margin-bottom: 15px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                        ...
                        <div style="background: #fff3cd; padding: 10px 15px; display: flex; justify-content: space-between; font-weight: bold;">
