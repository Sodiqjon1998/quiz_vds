...
<style>
    ...
    .breadcrumb-item + .breadcrumb-item::before {
        content: ">" !important; /* Bootstrapning default / ni o'zgartirish */
        color: #6c757d;
    ...
    .option-display .icon {
        margin-right: 15px;
        font-size: 1.2em;
        min-width: 20px; /* Ikonka uchun joy ajratish */
        text-align: center;
    }

    .option-display.correct-answer {
        background-color: #d4edda; /* Ochiq yashil */
    ...
    .option-display.user-selected-incorrect {
        background-color: #f8d7da; /* Ochiq qizil */
