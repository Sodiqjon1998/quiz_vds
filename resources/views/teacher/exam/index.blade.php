                    ...
                    @if (count($model) > 0)
                        @foreach ($model as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <strong>Urunishlar soni: </strong> {{ Quiz::getAttachmentById($item->id)->number ?? '-----' }}
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    {{-- <a href="{{ route('teacher.question.create', $item->id) }}"
                                        class="badge bg-label-primary badge-lg rounded-pill">
                                        <i style="font-size: 16px" class="ri-questionnaire-line"></i>
                                    </a>
