    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Highcharts.chart('container', {
                ...
                title: {
                    text: 'Andijon Yuksalish Maktabining O\'qituvchi va Koordinatorlar soni'
                },
                subtitle: {
                    text: 'Maktab statistikasi'
                },
                xAxis: {
                    categories: ['O\'qituvchilar', 'Koordinatorlar'],
                    title: {
                        text: null
                    },
                    gridLineWidth: 1,
                ...
                yAxis: {
                    ...
                    gridLineWidth: 0,
                    allowDecimals: false, // O'nlik sonlarni chiqarish
                    tickInterval: 1
                },
                tooltip: {
                    valueSuffix: ' kishi'
                ...
                series: [{
                    ...
                    name: '{{ date('Y') - 1 }} Yil',
                    data: [{{ $teachers2024 }}, {{ $koordinators2024 }}]
                }]
            });
        });
