...
@section('content')
    ...
    {{--                                </td>--}}
    {{--                                <td>--}}
    {{--                                    @if ($item->user_type == Users::TYPE_ADMIN)--}}
    {{--                                        <small class="badge bg-label-primary badge-sm rounded-pill">--}}
    {{--                                            {{ Users::getTypes($item->user_type) }}--}}
    {{--                                        </small>--}}
    {{--                                    @elseif($item->user_type == Users::TYPE_TEACHER)--}}
    {{--                                        <small class="badge bg-label-success badge-sm rounded-pill">--}}
    {{--                                            {{ Users::getTypes($item->user_type) . ': ' . Users::getSubjectsById($item->subject_id)->name ?? '------' }}--}}
    {{--                                        </small>--}}
    {{--                                    @else--}}
    {{--                                        <small class="badge bg-label-primary badge-sm rounded-pill">--}}
    {{--                                            {{ Users::getTypes($item->user_type) }}--}}
